...
func (r *requestResolver) PotentialProviders(ctx context.Context, obj *models.Request) ([]PotentialProvider, error) {
	if obj == nil {
...
func (r *mutationResolver) AddMeAsPotentialProvider(ctx context.Context, input PotentialProviderInput) (*models.Request, error) {
	cUser := models.CurrentUser(ctx)
	...
	if err := provider.NewWithRequestUUID(input.RequestID, cUser.ID); err != nil {
