...
type MutationResolver interface {
	...
	AddMeAsPotentialProvider(ctx context.Context, input PotentialProviderInput) (*models.Request, error)
...
type RequestResolver interface {
	...
	PotentialProviders(ctx context.Context, obj *models.Request) ([]PotentialProvider, error)
