...
func (ms *ModelSuite) TestSendNotificationRequestFromStatus() {
	...
	tests := []struct {
		...
		{name: "Good - Accepted to Committed",
			...
			template:         getT(domain.MessageTemplateRequestFromAcceptedToCommitted),
		...
		{name: "Good - Accepted to Completed",
			post:             posts[0],
			template:         getT(domain.MessageTemplateRequestFromAcceptedToCompleted),
		...
		{name: "Bad - Accepted to Completed", // No Provider
			...
			wantErrLog: fmt.Sprintf("error preparing '%s' notification - no provider\n",
				getT(domain.MessageTemplateRequestFromAcceptedToCompleted)),
		},
		{name: "Good - Accepted to Delivered",
			post:             posts[0],
			template:         getT(domain.MessageTemplateRequestFromAcceptedToDelivered),
		...
		{name: "Good - Accepted to Open",
			...
			template:         getT(domain.MessageTemplateRequestFromAcceptedToOpen),
		...
		{name: "Good - Accepted to Removed",
			post:             posts[0],
			template:         getT(domain.MessageTemplateRequestFromAcceptedToRemoved),
		...
		{name: "Bad - Accepted to Removed", // No Provider
			...
			sendFunction: sendNotificationRequestFromAcceptedToRemoved,
			wantErrLog: fmt.Sprintf("error preparing '%s' notification - no provider\n",
				getT(domain.MessageTemplateRequestFromAcceptedToRemoved)),
		},
		{name: "Good - Committed to Accepted",
			post:             posts[0],
			template:         getT(domain.MessageTemplateRequestFromCommittedToAccepted),
		...
		{name: "Bad - Committed to Accepted", // No Provider
			...
			sendFunction: sendNotificationRequestFromCommittedToAccepted,
			wantErrLog: fmt.Sprintf("error preparing '%s' notification - no provider\n",
				getT(domain.MessageTemplateRequestFromCommittedToAccepted)),
		},
		{name: "Good - Committed to Delivered",
			post:             posts[0],
			template:         getT(domain.MessageTemplateRequestFromCommittedToDelivered),
			sendFunction:     sendNotificationRequestFromAcceptedOrCommittedToDelivered,
			wantEmailsSent:   1,
			wantToEmail:      posts[0].CreatedBy.Email,
		...
		{name: "Good - Committed to Open - Provider",
			...
			template:         getT(domain.MessageTemplateRequestFromCommittedToOpen),
		...
		{name: "Good - Committed to Removed",
			post:             posts[0],
			template:         getT(domain.MessageTemplateRequestFromCommittedToRemoved),
		...
		{name: "Bad - Committed to Removed", // No Provider
			...
			sendFunction: sendNotificationRequestFromCommittedToRemoved,
			wantErrLog: fmt.Sprintf("error preparing '%s' notification - no provider\n",
				getT(domain.MessageTemplateRequestFromCommittedToRemoved)),
		},
		{name: "Good - Completed to Accepted",
			post:             posts[0],
			template:         getT(domain.MessageTemplateRequestFromCompletedToAccepted),
		...
		{name: "Bad - Completed to Accepted", // No Provider
			...
			sendFunction: sendNotificationRequestFromCompletedToAcceptedOrDelivered,
			wantErrLog: fmt.Sprintf("error preparing '%s' notification - no provider\n",
				getT(domain.MessageTemplateRequestFromCompletedToAccepted)),
		},
		{name: "Good - Delivered to Accepted",
			post:             posts[0],
			template:         getT(domain.MessageTemplateRequestFromDeliveredToAccepted),
		...
		{name: "Good - Delivered to Committed",
			post:             posts[0],
			template:         getT(domain.MessageTemplateRequestFromDeliveredToCommitted),
		...
		{name: "Good - Delivered to Completed",
			post:             posts[0],
			template:         getT(domain.MessageTemplateRequestFromDeliveredToCompleted),
			sendFunction:     sendNotificationRequestFromAcceptedOrDeliveredToCompleted,
			wantEmailsSent:   1,
			wantToEmail:      posts[0].Provider.Email,
			wantBodyContains: "Thank you for fulfilling a request",
		...
		{name: "Good - Open to Committed",
			post:             posts[0],
			template:         getT(domain.MessageTemplateRequestFromOpenToCommitted),
		...
		{name: "Bad - Open to Committed", // No Provider
			...
			sendFunction: sendNotificationRequestFromOpenToCommitted,
			wantErrLog: fmt.Sprintf("error preparing '%s' notification - no provider\n",
				getT(domain.MessageTemplateRequestFromOpenToCommitted)),
		},
	}
